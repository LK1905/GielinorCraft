...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractAlloyFurnaceScreen<T extends AbstractAlloyFurnaceMenu> extends  AbstractContainerScreen<T> implements RecipeUpdateListener {
	...
	private static final ResourceLocation RECIPE_BUTTON_LOCATION = new ResourceLocation("textures/gui/recipe_button.png");
	   ...
	   public AbstractAlloyFurnaceScreen(T p_97825_, AbstractFurnaceRecipeBookComponent p_97826_, Inventory p_97827_, Component p_97828_, ResourceLocation p_97829_) {
