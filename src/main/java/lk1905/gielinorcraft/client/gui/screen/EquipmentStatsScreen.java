...
public class EquipmentStatsScreen extends Screen{
	...
	public void render(final MatrixStack stack, final int mouseX, final int mouseY, final float partialTicks) {
		...
		drawString(stack, font, "Magic: " + stats.getTotalAccuracy(3), (width / 2) - 100, height - 140, 111111);
		drawString(stack, font, "Ranged: " + stats.getTotalAccuracy(4), (width / 2) - 100, height - 130, 111111);
		...
		drawString(stack, font, "Magic: " + stats.getTotalDefence(3), (width / 2) + 20, height - 140, 111111);
		drawString(stack, font, "Ranged: " + stats.getTotalDefence(4), (width / 2) + 20, height - 130, 111111);
